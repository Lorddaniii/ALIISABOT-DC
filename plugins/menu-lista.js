...
rows: [
     ...
     {title: "│🏓│ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs", description: "ᴇɴʟᴀᴄᴇs ᴅᴇ ʟᴏs ɢʀᴜᴘᴏs ᴅᴇ ALISABOT-DC", rowId: `${usedPrefix}grupos`},
     {title: "│⏱️│ʜᴏʀᴀʀɪᴏ", description: "ʜᴏʀᴀʀɪᴏ ᴅᴇ ᴍᴇxɪᴄᴏ", rowId: `${usedPrefix}horario`},
     {title: "│🧿│ᴘᴀɢɪɴᴀs ᴅᴇ ɢɪᴛ", description: "ɢɪᴛ ᴏғɪᴄɪᴀʟ ᴅᴇ ALISABOT-DC", rowId: `${usedPrefix}sc`},
     ...
     {title: "│📵│ᴅᴇsᴀᴄᴛɪᴠᴀʀ ᴀɴᴛɪᴘʀɪᴠᴀᴅᴏ", description: "sᴏʟᴏ ᴘᴜᴇᴅᴇ sᴇʀ ᴜsᴀᴅᴏ ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ ᴘᴏʀ ᴀᴅᴍɪɴ ᴏ ᴇʟ ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ ", rowId: `${usedPrefix}disable antiprivado`},
      ...
      {title: "│🎋│ALISABOT-DC", description: "ɪᴍᴀɢᴇɴᴇs ᴅᴇ ALISABOT-DC", rowId: `${usedPrefix}alisabot`},
