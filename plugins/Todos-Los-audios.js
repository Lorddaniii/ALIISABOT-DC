...
if (!chat.isBanned && chat.audios && m.text.match(/(cancion alisabot|Cancion alisabot)/gi)) {    
let vn = './media/cancion alisabot.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}


   if (!chat.isBanned && chat.audios && m.text.match(/(cancion alisabot2|Cancion alisabot2)/gi)) {    
let vn = './media/cancion alisabot2.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(Alisabot es genial|alisabot es genial)/gi)) {    
let vn = './media/alisabot es genial.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = './media/buenas tardes.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 
...
let vn = './media/quién poronga.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 
...
let vn = './media/si no le gusta.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 
...
let vn = './media/Yamete-kudasai2.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 
